...
kicker = ParagraphStyle("Kicker", parent=styles["Normal"], fontName="Courier", fontSize=8, leading=11, textColor=rust, spaceAfter=16)
title = ParagraphStyle("Title", parent=styles["Title"], fontName="Times-Bold", fontSize=34, leading=36, textColor=ink, spaceAfter=16)
subtitle = ParagraphStyle("Subtitle", parent=styles["Normal"], fontName="Times-Roman", fontSize=16, leading=22, textColor=muted, spaceAfter=16)
heading = ParagraphStyle("Heading", parent=styles["Heading1"], fontName="Times-Bold", fontSize=23, leading=26, textColor=ink, spaceAfter=18)
...
callout = ParagraphStyle("Callout", parent=styles["Normal"], fontName="Times-Roman", fontSize=13, leading=18, textColor=ink)
...
def card(label_text, heading_text, copy, accent=acid, width=61 * mm, height=47 * mm):
...
def row(cards):
    table = Table([cards], colWidths=[67 * mm] * len(cards), hAlign="LEFT")
    table.setStyle(TableStyle([("VALIGN", (0, 0), (-1, -1), "TOP"), ("LEFTPADDING", (0, 0), (-1, -1), 0), ("RIGHTPADDING", (0, 0), (-1, -1), 5)]))
    return table


story = []
story.extend([P("EMK / PRESENTATION BRIEF / 01", kicker), Spacer(1, 18 * mm), P("The link gallery", title), P("A professional Streamlit console for turning EMK artwork links into a clear, searchable, measurable gallery workflow.", subtitle), Spacer(1, 12 * mm), Table([[P("From scattered links to a curated collection with visible business priorities.", callout)]], colWidths=[225 * mm], style=[("BACKGROUND", (0, 0), (-1, -1), colors.HexColor("#edf4d8")), ("LINEBEFORE", (0, 0), (0, -1), 4, acid), ("LEFTPADDING", (0, 0), (-1, -1), 12), ("TOPPADDING", (0, 0), (-1, -1), 10), ("BOTTOMPADDING", (0, 0), (-1, -1), 10)]), PageBreak()])
